...
export const getGenres = createAsyncThunk("movietime/genres", async () => {
    const {data: {
       genres 
    }} = await axios.get(
...
export const fetchDataByGenre =createAsyncThunk("movie/moviesByGenre", async({genre, type},thunkApi) => {
    const {
            movietime: { genres },
        } = thunkApi.getState();
...
export const store = configureStore({
    reducer: {
        movietime: MovieTimeSlice.reducer,
    }
})